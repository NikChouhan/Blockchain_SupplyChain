...
/// @title MedicineW_D
/// @notice
/// @dev Sub Contract for Medicine Transaction between Wholesaler and distributor
contract MedicineW_D {
    ...
    /// @notice
    /// @dev Get Medicine Batch Transaction status in between Wholesaler and distributor
